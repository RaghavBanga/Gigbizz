...
public class SubmittedReportListLoanCommonAdapter extends RecyclerView.Adapter<SubmittedReportListLoanCommonAdapter.MyViewHolder>{

    private List<SubmittedLoan> items1;

    private OnClickListner onClickListner;

    public SubmittedReportListLoanCommonAdapter(List<SubmittedLoan> items, OnClickListner  onClickListner){
        this.items1 = items;
        this.onClickListner = onClickListner;
    }

    public void setNewList(List<SubmittedLoan> items){
        this.items1 = items;
    ...
    public void onBindViewHolder(MyViewHolder holder, @SuppressLint("RecyclerView") int position){
        ...
        SubmittedLoan taskModel = items1.get(position);
