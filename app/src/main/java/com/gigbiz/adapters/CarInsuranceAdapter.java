...
public class CarInsuranceAdapter extends RecyclerView.Adapter<CarInsuranceAdapter.MyViewHolder>{

    private List<TaskModel> items;
    private OnClickListner onClickListner;
    private String type;

    public CarInsuranceAdapter(List<TaskModel> items, OnClickListner  onClickListner){
        this.items = items;
