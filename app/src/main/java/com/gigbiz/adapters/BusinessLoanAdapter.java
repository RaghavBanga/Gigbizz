...
public class BusinessLoanAdapter extends RecyclerView.Adapter<BusinessLoanAdapter.MyViewHolder>{

    private List<TaskModel> items;
    private OnClickListner onClickListner;
    private String type;

    public BusinessLoanAdapter(List<TaskModel> items, OnClickListner  onClickListner){
        this.items = items;
