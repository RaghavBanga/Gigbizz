...
public class PersonalLoansAdapter extends RecyclerView.Adapter<PersonalLoansAdapter.MyViewHolder>{

    private List<TaskModel> items;
    private OnClickListner onClickListner;
    private String type;

    public PersonalLoansAdapter(List<TaskModel> items, OnClickListner onClickListner){
        this.items = items;
