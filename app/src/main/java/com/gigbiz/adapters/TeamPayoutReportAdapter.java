...
public class TeamPayoutReportAdapter extends RecyclerView.Adapter<TeamPayoutReportAdapter.ViewHolder> {

    Context context;
    List<Project_Report> payment_list;

    public TeamPayoutReportAdapter(Context context, List<Project_Report> payment_list) {
