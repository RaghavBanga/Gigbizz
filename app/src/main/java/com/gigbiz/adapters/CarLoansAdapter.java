...
public class CarLoansAdapter extends RecyclerView.Adapter<CarLoansAdapter.MyViewHolder>{

    private List<TaskModel> items;
    private OnClickListner onClickListner;
    private String type;

    public CarLoansAdapter(List<TaskModel> items, OnClickListner  onClickListner){
        this.items = items;
