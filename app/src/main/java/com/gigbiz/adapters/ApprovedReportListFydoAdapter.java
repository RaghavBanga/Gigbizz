...
public class ApprovedReportListFydoAdapter  extends RecyclerView.Adapter<ApprovedReportListFydoAdapter.MyViewHolder>{

    private List<ApprovedFydo> items1;

    private OnClickListner onClickListner;

    public ApprovedReportListFydoAdapter(List<ApprovedFydo> items, OnClickListner  onClickListner){
        this.items1 = items;
        this.onClickListner = onClickListner;
    }

    public void setNewList(List<ApprovedFydo> items){
        this.items1 = items;
    ...
    public void onBindViewHolder(MyViewHolder holder, @SuppressLint("RecyclerView") int position){
        ...
        ApprovedFydo taskModel = items1.get(position);
