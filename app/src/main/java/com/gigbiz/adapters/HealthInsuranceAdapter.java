...
public class HealthInsuranceAdapter extends RecyclerView.Adapter<HealthInsuranceAdapter.MyViewHolder>{

    private List<TaskModel> items;
    private OnClickListner onClickListner;
    private String type;

    public HealthInsuranceAdapter(List<TaskModel> items, OnClickListner onClickListner){
        this.items = items;
