...
public class SubmittedReportListInsuranceCommonAdapter extends RecyclerView.Adapter<SubmittedReportListInsuranceCommonAdapter.MyViewHolder>{

    private List<SubmittedInsurance> items1;

    private OnClickListner onClickListner;

    public SubmittedReportListInsuranceCommonAdapter(List<SubmittedInsurance> items, OnClickListner  onClickListner){
        this.items1 = items;
        this.onClickListner = onClickListner;
    }

    public void setNewList(List<SubmittedInsurance> items){
        this.items1 = items;
    ...
    public void onBindViewHolder(MyViewHolder holder, @SuppressLint("RecyclerView") int position){
        ...
        SubmittedInsurance taskModel = items1.get(position);
