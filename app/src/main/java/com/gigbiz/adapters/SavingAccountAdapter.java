...
public class SavingAccountAdapter extends RecyclerView.Adapter<SavingAccountAdapter.MyViewHolder>{

    private List<TaskModel> items;
    private OnClickListner onClickListner;
    private String type;

    public SavingAccountAdapter(List<TaskModel> items, OnClickListner  onClickListner){
        this.items = items;
