...
public class ApprovedReportListInsuranceCommonAdapter extends RecyclerView.Adapter<ApprovedReportListInsuranceCommonAdapter.MyViewHolder>{

    private List<ApprovedInsurance> items1;

    private OnClickListner onClickListner;

    public ApprovedReportListInsuranceCommonAdapter(List<ApprovedInsurance> items, OnClickListner  onClickListner){
        this.items1 = items;
        this.onClickListner = onClickListner;
    }

    public void setNewList(List<ApprovedInsurance> items){
        this.items1 = items;
    ...
    public void onBindViewHolder(MyViewHolder holder, @SuppressLint("RecyclerView") int position){
        ...
        ApprovedInsurance taskModel = items1.get(position);
