...
public class RejectedReportListFydoAdapter extends RecyclerView.Adapter<RejectedReportListFydoAdapter.MyViewHolder>{

    private List<RejectedFydo> items1;

    private OnClickListner onClickListner;

    public RejectedReportListFydoAdapter(List<RejectedFydo> items, OnClickListner  onClickListner){
        this.items1 = items;
        this.onClickListner = onClickListner;
    }

    public void setNewList(List<RejectedFydo> items){
        this.items1 = items;
    ...
    public void onBindViewHolder(MyViewHolder holder, @SuppressLint("RecyclerView") int position){
        ...
        RejectedFydo taskModel = items1.get(position);
