...
public class RejectedReportListCreditCommonAdapter extends RecyclerView.Adapter<RejectedReportListCreditCommonAdapter.MyViewHolder>{

    private List<RejectedCredit> items1;

    private OnClickListner onClickListner;

    public RejectedReportListCreditCommonAdapter(List<RejectedCredit> items, OnClickListner  onClickListner){
        this.items1 = items;
        this.onClickListner = onClickListner;
    }

    public void setNewList(List<RejectedCredit> items){
        this.items1 = items;
    ...
    public void onBindViewHolder(MyViewHolder holder, @SuppressLint("RecyclerView") int position){
        ...
        RejectedCredit taskModel = items1.get(position);
