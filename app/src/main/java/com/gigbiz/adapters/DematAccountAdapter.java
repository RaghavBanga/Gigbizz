...
public class DematAccountAdapter extends RecyclerView.Adapter<DematAccountAdapter.MyViewHolder>{

    private List<TaskModel> items;
    private OnClickListner onClickListner;
    private String type;

    public DematAccountAdapter(List<TaskModel> items, OnClickListner  onClickListner){
        this.items = items;
