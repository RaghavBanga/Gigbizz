...
public class HomeLoansAdapter extends RecyclerView.Adapter<HomeLoansAdapter.MyViewHolder>{

    private List<TaskModel> items;
    private OnClickListner onClickListner;
    private String type;

    public HomeLoansAdapter(List<TaskModel> items, OnClickListner onClickListner){
        this.items = items;
