...
import com.gigbiz.adapters.RejectedReportListFydoAdapter;
import com.gigbiz.databinding.FragmentRejectedFydoBinding;
...
public class RejectedFydoFragment extends Fragment {
    FragmentRejectedFydoBinding binding;
    public String user_id;
    public String token;
    public String usertype;
    List<RejectedFydo> projects1;
    SharedPreferences sh;
    RejectedReportListFydoAdapter adapter;
    public boolean check = false;
    public static RejectedFydoFragment newInstance(String param1, String param2) {
        RejectedFydoFragment fragment = new RejectedFydoFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentRejectedFydoBinding.inflate(inflater, container, false);
        ...
        adapter = new RejectedReportListFydoAdapter(projects1, new OnClickListner() {
            @Override
