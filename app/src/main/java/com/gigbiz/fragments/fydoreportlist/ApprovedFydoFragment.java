...
import com.gigbiz.adapters.ApprovedReportListFydoAdapter;
import com.gigbiz.databinding.FragmentApprovedFydoBinding;
...
public class ApprovedFydoFragment extends Fragment {
    FragmentApprovedFydoBinding binding;
    public String user_id;
    public String token;
    public String usertype;
    List<ApprovedFydo> projects1;
    SharedPreferences sh;
    ApprovedReportListFydoAdapter adapter;
    public boolean check = false;

    public static ApprovedFydoFragment newInstance(String param1, String param2) {
        ApprovedFydoFragment fragment = new ApprovedFydoFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentApprovedFydoBinding.inflate(inflater, container, false);
        ...
        adapter = new ApprovedReportListFydoAdapter(projects1, new OnClickListner() {
            @Override
