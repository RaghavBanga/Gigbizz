package com.gigbiz.fragments.stepfollow;
...
import com.gigbiz.databinding.FragmentStepToFollowTabBinding;
...
public class StepToFollowTabFragment extends Fragment {

    FragmentStepToFollowTabBinding binding;
    List<Project> list;
    SharedPreferences sh;
    public String value,listtype;


    public StepToFollowTabFragment() {
        // Required empty public constructor
    }

    public static StepToFollowTabFragment newInstance(String param1, String param2) {
        StepToFollowTabFragment fragment = new StepToFollowTabFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentStepToFollowTabBinding.inflate(inflater, container, false);
        ...
        for (int i = 0; i < list.size(); i++) {
            if (value.equals(list.get(i).getProjectId())) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    binding.steptofollow.setText(Html.fromHtml(list.get(i).getStepToFollow(), Html.FROM_HTML_MODE_COMPACT));
                } else {
                    binding.steptofollow.setText(Html.fromHtml(list.get(i).getStepToFollow()));
                }
//                binding.steptofollow.setText(list.get(i).getStepToFollow());
            }
        }
    }
}