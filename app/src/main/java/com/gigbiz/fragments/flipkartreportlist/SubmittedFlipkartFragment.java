package com.gigbiz.fragments.flipkartreportlist;
...
import com.gigbiz.adapters.SubmittedReportListFlipkartAdapter;
import com.gigbiz.databinding.FragmentSubmittedFlipkartBinding;
...
public class SubmittedFlipkartFragment extends Fragment {

    FragmentSubmittedFlipkartBinding binding;
    public String user_id;
    public String token;
    public String usertype;
    List<SubmittedFlipkart> projects1;
    SharedPreferences sh;
    SubmittedReportListFlipkartAdapter adapter;
    public boolean check = false;

    public static SubmittedFlipkartFragment newInstance(String param1, String param2) {
        SubmittedFlipkartFragment fragment = new SubmittedFlipkartFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSubmittedFlipkartBinding.inflate(inflater, container, false);
        ...
        adapter = new SubmittedReportListFlipkartAdapter(projects1, new OnClickListner() {
            @Override
