...
import com.gigbiz.adapters.ApprovedReportListFlipkartAdapter;
import com.gigbiz.databinding.FragmentApprovedFlipkartBinding;
...
public class ApprovedFlipkartFragment extends Fragment {

    FragmentApprovedFlipkartBinding binding;
    public String user_id;
    public String token;
    public String usertype;
    List<ApprovedFlipkart> projects1;
    SharedPreferences sh;
    ApprovedReportListFlipkartAdapter adapter;
    public boolean check = false;

    public static ApprovedFlipkartFragment newInstance() {
        ApprovedFlipkartFragment fragment = new ApprovedFlipkartFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentApprovedFlipkartBinding.inflate(inflater, container, false);
        ...
        adapter = new ApprovedReportListFlipkartAdapter(projects1, new OnClickListner() {
            @Override
