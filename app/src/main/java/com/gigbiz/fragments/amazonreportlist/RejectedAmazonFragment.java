...
import com.gigbiz.adapters.RejectedReportListAmazonAdapter;
import com.gigbiz.databinding.FragmentRejectedAmazonBinding;
...
public class RejectedAmazonFragment extends Fragment {
    FragmentRejectedAmazonBinding binding;
    public String user_id;
    public String token;
    public String usertype;
    List<RejectedAmazon> projects1;
    SharedPreferences sh;
    RejectedReportListAmazonAdapter adapter;
    public boolean check = false;
    public static RejectedAmazonFragment newInstance(String param1, String param2) {
        RejectedAmazonFragment fragment = new RejectedAmazonFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentRejectedAmazonBinding.inflate(inflater, container, false);
        ...
        adapter = new RejectedReportListAmazonAdapter(projects1, new OnClickListner() {
            @Override
