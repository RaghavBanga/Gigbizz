...
import com.gigbiz.adapters.SubmittedReportListAirtelAdapter;
import com.gigbiz.databinding.FragmentSubmittedAirtelBinding;
...
public class SubmittedAirtelFragment extends Fragment {
    FragmentSubmittedAirtelBinding binding;
    public String user_id;
    public String token;
    public String usertype;
    List<SubmittedAirtel> projects1;
    SharedPreferences sh;
    SubmittedReportListAirtelAdapter adapter;
    public boolean check = false;
    public static SubmittedAirtelFragment newInstance(String param1, String param2) {
        SubmittedAirtelFragment fragment = new SubmittedAirtelFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSubmittedAirtelBinding.inflate(inflater, container, false);
        ...
        adapter = new SubmittedReportListAirtelAdapter(projects1, new OnClickListner() {
            @Override
