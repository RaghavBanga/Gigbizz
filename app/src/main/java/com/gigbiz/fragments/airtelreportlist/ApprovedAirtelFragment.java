...
import com.gigbiz.adapters.ApprovedReportListAirtelAdapter;
import com.gigbiz.databinding.FragmentApprovedAirtelBinding;
...
public class ApprovedAirtelFragment extends Fragment {
    FragmentApprovedAirtelBinding binding;
    public String user_id;
    public String token;
    public String usertype;
    List<ApprovedAirtel> projects1;
    SharedPreferences sh;
    ApprovedReportListAirtelAdapter adapter;
    public boolean check = false;

    public static ApprovedAirtelFragment newInstance(String param1, String param2) {
        ApprovedAirtelFragment fragment = new ApprovedAirtelFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentApprovedAirtelBinding.inflate(inflater, container, false);
        ...
        adapter = new ApprovedReportListAirtelAdapter(projects1, new OnClickListner() {
            @Override
