...
public class ApprovedCredit {
    ...
    public ApprovedCredit(String reportId, String userId, String projectId, String name, String email, String mobile, String aadharFront, String aadharBack, String panCard, String twomonthCreditCardStatement, String twomonthBankStatement, String twomonthSalarySlip, String status, String reason) {
        super();
