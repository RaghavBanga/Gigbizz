...
public class Submitted {
    ...
    public Submitted withReportId(String reportId) {
        this.reportId = reportId;
        return this;
    }
    ...
    public Submitted withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Submitted withProjectId(String projectId) {
        this.projectId = projectId;
        return this;
    }
    ...
    public Submitted withShopNo(String shopNo) {
        this.shopNo = shopNo;
        return this;
    }
    ...
    public Submitted withShopName(String shopName) {
        this.shopName = shopName;
        return this;
    }
    ...
    public Submitted withShopPhone(String shopPhone) {
        this.shopPhone = shopPhone;
        return this;
    }
    ...
    public Submitted withCatId(String catId) {
        this.catId = catId;
        return this;
    }
    ...
    public Submitted withCatName(String catName) {
        this.catName = catName;
        return this;
    }
    ...
    public Submitted withCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public Submitted withPincode(String pincode) {
        this.pincode = pincode;
        return this;
    }
    ...
    public Submitted withQrcodeId(String qrcodeId) {
        this.qrcodeId = qrcodeId;
        return this;
    }
    ...
    public Submitted withQrcodeName(String qrcodeName) {
        this.qrcodeName = qrcodeName;
        return this;
    }
    ...
    public Submitted withQrcodePicPrimary(String qrcodePicPrimary) {
        this.qrcodePicPrimary = qrcodePicPrimary;
        return this;
    }
    ...
    public Submitted withQrcodePicSecondary(String qrcodePicSecondary) {
        this.qrcodePicSecondary = qrcodePicSecondary;
        return this;
    }
    ...
    public Submitted withTentCardPic(String tentCardPic) {
        this.tentCardPic = tentCardPic;
        return this;
    }
    ...
    public Submitted withSmallStickerPic(String smallStickerPic) {
        this.smallStickerPic = smallStickerPic;
        return this;
    }
    ...
    public Submitted withLargeStickerPic(String largeStickerPic) {
        this.largeStickerPic = largeStickerPic;
        return this;
    }
    ...
    public Submitted withHangingCollectralPic(String hangingCollectralPic) {
        this.hangingCollectralPic = hangingCollectralPic;
        return this;
    }
    ...
    public Submitted withNoOfTentCard(String noOfTentCard) {
        this.noOfTentCard = noOfTentCard;
        return this;
    }
    ...
    public Submitted withNoOfAfourPoster(String noOfAfourPoster) {
        this.noOfAfourPoster = noOfAfourPoster;
        return this;
    }
    ...
    public Submitted withNoOfSmallSticker(String noOfSmallSticker) {
        this.noOfSmallSticker = noOfSmallSticker;
        return this;
    }
    ...
    public Submitted withNoOfTraditionalDangler(String noOfTraditionalDangler) {
        this.noOfTraditionalDangler = noOfTraditionalDangler;
        return this;
    }
    ...
    public Submitted withNoOfBunting(String noOfBunting) {
        this.noOfBunting = noOfBunting;
        return this;
    }
    ...
    public Submitted withComments(String comments) {
        this.comments = comments;
        return this;
    }
    ...
    public Submitted withReason(Object reason) {
        this.reason = reason;
        return this;
    }
