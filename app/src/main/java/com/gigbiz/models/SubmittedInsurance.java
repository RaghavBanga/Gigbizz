...
public class SubmittedInsurance {
    ...
    public SubmittedInsurance(String reportId, String userId, String projectId, String name, String email, String mobile, String aadharFront, String aadharBack, String panCard, String insuranceType, String status, String reason) {
        super();
