...
public class ApprovedAirtel {
    ...
    public ApprovedAirtel(String reportId, String userId, String projectId, String userType, String shopName, String agencyName, String shopMobile, String fseName, String fseMobile, String transDone, String transPic, String uploadCodePic, String reason) {
        super();
