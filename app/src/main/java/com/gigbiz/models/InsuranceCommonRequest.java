...
public class InsuranceCommonRequest {
    ...
    public InsuranceCommonRequest(String userId, String token, String userType, String projectId, String name, String email, String mobile, String aadharFront, String aadharBack, String panCard, String insuranceType) {
        super();
        this.userId = userId;
        this.token = token;
