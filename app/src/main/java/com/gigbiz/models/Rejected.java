...
public class Rejected {
    ...
    public Rejected withReportId(String reportId) {
        this.reportId = reportId;
        return this;
    }
    ...
    public Rejected withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Rejected withProjectId(String projectId) {
        this.projectId = projectId;
        return this;
    }
    ...
    public Rejected withShopNo(String shopNo) {
        this.shopNo = shopNo;
        return this;
    }
    ...
    public Rejected withShopName(String shopName) {
        this.shopName = shopName;
        return this;
    }
    ...
    public Rejected withShopPhone(String shopPhone) {
        this.shopPhone = shopPhone;
        return this;
    }
    ...
    public Rejected withCatId(String catId) {
        this.catId = catId;
        return this;
    }
    ...
    public Rejected withCatName(String catName) {
        this.catName = catName;
        return this;
    }
    ...
    public Rejected withCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public Rejected withPincode(String pincode) {
        this.pincode = pincode;
        return this;
    }
    ...
    public Rejected withQrcodeId(String qrcodeId) {
        this.qrcodeId = qrcodeId;
        return this;
    }
    ...
    public Rejected withQrcodeName(String qrcodeName) {
        this.qrcodeName = qrcodeName;
        return this;
    }
    ...
    public Rejected withQrcodePicPrimary(String qrcodePicPrimary) {
        this.qrcodePicPrimary = qrcodePicPrimary;
        return this;
    }
    ...
    public Rejected withQrcodePicSecondary(String qrcodePicSecondary) {
        this.qrcodePicSecondary = qrcodePicSecondary;
        return this;
    }
    ...
    public Rejected withTentCardPic(String tentCardPic) {
        this.tentCardPic = tentCardPic;
        return this;
    }
    ...
    public Rejected withSmallStickerPic(String smallStickerPic) {
        this.smallStickerPic = smallStickerPic;
        return this;
    }
    ...
    public Rejected withLargeStickerPic(String largeStickerPic) {
        this.largeStickerPic = largeStickerPic;
        return this;
    }
    ...
    public Rejected withHangingCollectralPic(String hangingCollectralPic) {
        this.hangingCollectralPic = hangingCollectralPic;
        return this;
    }
    ...
    public Rejected withNoOfTentCard(String noOfTentCard) {
        this.noOfTentCard = noOfTentCard;
        return this;
    }
    ...
    public Rejected withNoOfAfourPoster(String noOfAfourPoster) {
        this.noOfAfourPoster = noOfAfourPoster;
        return this;
    }
    ...
    public Rejected withNoOfSmallSticker(String noOfSmallSticker) {
        this.noOfSmallSticker = noOfSmallSticker;
        return this;
    }
    ...
    public Rejected withNoOfTraditionalDangler(String noOfTraditionalDangler) {
        this.noOfTraditionalDangler = noOfTraditionalDangler;
        return this;
    }
    ...
    public Rejected withNoOfBunting(String noOfBunting) {
        this.noOfBunting = noOfBunting;
        return this;
    }
    ...
    public Rejected withComments(String comments) {
        this.comments = comments;
        return this;
    }
    ...
    public Rejected withReason(Object reason) {
        this.reason = reason;
        return this;
    }
