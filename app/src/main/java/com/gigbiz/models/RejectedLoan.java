...
public class RejectedLoan {
    ...
    public RejectedLoan(String reportId, String userId, String projectId, String name, String email, String mobile, String aadharFront, String aadharBack, String panCard, String sixmonthBankStatement, String sixmonthSalarySlip, String status, String reason) {
        super();
